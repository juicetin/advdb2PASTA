...
public class DiskManager implements DatabaseConstants {
     ...
     * If database does not exist, will create it wil 1 page
     ...
     * @throws IOException failed to open/write to database
     */
    ...
    /**
     * Deletes the file representing the database. Any DiskManager object should no longer be used
